...
# app
bot_token = os.environ.get("TOKEN", "5619408828:AAHWI7oeQL_eTeR9bABCU-RNoG2_myLk2Rw") 
api_hash = os.environ.get("HASH", "e8ec35bc8449ef3fae5b4bb0a5b302de") 
api_id = os.environ.get("ID", "14358897")
api_win = os.environ.get("WIN", "0")
